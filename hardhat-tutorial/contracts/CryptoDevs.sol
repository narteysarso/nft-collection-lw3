...
contract CryptoDevs is ERC721Enumerable, Ownable {
     ...
     * will be the concantenation of the baseURI and the tokenId.
     */
    ...
    //boolean to keep track of whether presale have started or not
    ...
    *@dev startPresale starts a presale for the whitelisted addresses
    ...
    function startPresale() public onlyOwner {
        ...
        //solidity has a cool syntax for timestamp(seconds, minutes, hours, days, years);
    ...
    function presaleMint() public payable onlyWhenNotPaused {
        ...
        // If the address being minted to is not a contract, then it works the same as _mint
